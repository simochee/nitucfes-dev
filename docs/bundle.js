...
/***/ function(module, exports, __webpack_require__) {
	...
	// PlayGroundのロジック
	var playground = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anime = __webpack_require__(5);
	
	var gimmick = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tmps = __webpack_require__(8);
	...
	module.exports = {
		updateBaseHeight: function updateBaseHeight() {
			var len = store.level.length;
			var height = store.level * 80 + 60 + store.margin.top + store.margin.bottom;
			for (var i = 1; i < len; i++) {}
		...
		insertIf: function insertIf() {
			$(document).on('click', '.show-if .row .if', function () {
				var type = $(this).data('type');
				var $focus = $('.choose.focus');
				var x = $focus.data('x');
				var y = $focus.data('y');
				var html = tmps.if(type, x, y);
...
/***/ function(module, exports) {
	...
	module.exports = {
		if: function _if(type, x, y) {
			var tmp = function tmp(text) {
